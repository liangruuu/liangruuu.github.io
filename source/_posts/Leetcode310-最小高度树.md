...
categories:
  - 算法
abbrlink: f0d1bb1d
date: 2020-08-27 08:36:29
---

建图方法详见和BFS问题模板详见[BFS问题模板](./BFS问题模板.md)

**转载自：[Leetcode题解（小鑫），略有增删](https://leetcode-cn.com/problems/minimum-height-trees/solution/zui-rong-yi-li-jie-de-bfsfen-xi-jian-dan-zhu-shi-x/)**

<!-- more -->

**本题简而言之就是`剥洋葱`，从外到内二分图的距离，找到最内层的元素**
...
1. 因为题目已经给出图的点与边的关系，所以在进行队列操作之前就使用邻接矩阵方式构造图
2. 使用保存节点**度**值的数组来对图节点元素出入队进行辅助操作
